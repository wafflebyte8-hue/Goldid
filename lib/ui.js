 ...
 * Terminal language: crisp gold accents over neutral dark surfaces, panel-first
 * layouts, quiet status helpers, masked key entry, and keyboard navigable setup
...
const gold = rgb(255, 211, 108, true);
const amber = rgb(242, 184, 75);
const bronze = rgb(116, 128, 148);
const mutedGold = rgb(170, 180, 196);
const cream = rgb(244, 247, 251);
const dim = color.dim;
